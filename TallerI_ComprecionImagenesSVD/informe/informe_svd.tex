...
La Tabla~\ref{tab:resumen} presenta el consolidado de m\'{e}tricas para todas las im\'{a}genes y valores de $k$ evaluados. El rango completo $r$ coincide con la dimensi\'{o}n menor de cada imagen.
...
Las Figuras~\ref{fig:panel3} a \ref{fig:panel8} muestran los paneles combinados (error, energ\'{i}a y tasa de compresi\'{o}n) para im\'{a}genes representativas. Las Figuras~\ref{fig:comp-error} y \ref{fig:comp-energia} presentan comparativas normalizadas del dataset completo.
...
A continuaci\'{o}n se presentan comparaciones visuales entre la imagen original y las reconstrucciones $A_k$ para distintos valores de $k$. Las im\'{a}genes se ubican en \texttt{resultados/reconstrucciones/}.
...
\label{fig:lena-reconstrucciones}
\end{figure}

\subsubsection{Mandril escala de grises (ID 4)}

\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/grises/mandril_gris_4.png}
    \caption{Original}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_4_5.png}
    \caption{$k=5$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_4_20.png}
    \caption{$k=20$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_4_50.png}
    \caption{$k=50$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_4_100.png}
    \caption{$k=100$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_4_200.png}
    \caption{$k=200$}
\end{subfigure}
\caption{Reconstrucciones de mandril (gris) para $k \in \{5, 20, 50, 100, 200\}$. Con $k=50$ la imagen ya es visualmente indistinguible del original.}
\label{fig:mandril-reconstrucciones}
\end{figure}

\subsubsection{Edificio RGB (ID 5)}

\begin{figure}[H]
\centering
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{assets/rgb/edificio_rgb_5.png}
    \caption{Original}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_5_5.png}
    \caption{$k=5$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_5_20.png}
    \caption{$k=20$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_5_50.png}
    \caption{$k=50$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_5_100.png}
    \caption{$k=100$}
\end{subfigure}
\hfill
\begin{subfigure}[b]{0.18\textwidth}
    \centering
    \includegraphics[width=\textwidth]{resultados/reconstrucciones/ak_5_200.png}
    \caption{$k=200$}
\end{subfigure}
\caption{Reconstrucciones de Edificio (RGB) para $k \in \{5, 20, 50, 100, 200\}$. Con $k=200$ la imagen ya es visualmente indistinguible del original.}
\label{fig:edificio-reconstrucciones}
\end{figure}
...
\label{fig:pimiento-reconstrucciones}
\end{figure}
...
\bibitem{compton} Compton, A. (2020). \textit{Singular Value Decomposition: Applications to Image Processing.} Lagrange College Undergraduate Research.
